    ...
    it('returns a list of categories', done => {
      supertest(server)
        ...
        .end((err, res) => {
          ...
          expect(res.body.results[0]).that.has.all.keys('__v', '_id', 'categoryName', 'createdAt', 'updatedAt');
        ...
        supertest(server)
          ...
          .end((error, res) => {
            ...
            expect(res.body)
              .to.have.property('message')
              .to.be.a('string');
            expect(res.body.results).that.has.all.keys('__v', '_id', 'categoryName', 'createdAt', 'updatedAt');
    ...
    it('add a new category', done => {
      ...
      supertest(server)
        ...
        .end((err, res) => {
          ...
          expect(res.body.results)
            .to.be.an('object')
            .that.has.all.keys('__v', '_id', 'categoryName', 'createdAt', 'updatedAt');
          expect(res.body.results)
            .to.have.property('_id')
            .to.be.a('string')
            .to.have.lengthOf(24);
      ...
      Category.findOne({}).exec((err, category) => {
        supertest(server)
          ...
          .end((error, res) => {
            ...
            expect(res.body.results)
              .to.be.an('object')
              .that.has.all.keys('_id', 'categoryName');
            expect(res.body.results)
              .to.have.property('_id')
              .to.be.a('string')
              .to.have.lengthOf(24);
